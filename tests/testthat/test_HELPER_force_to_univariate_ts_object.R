...
context("force_to_univariate_ts_object")

test_that("check force_to_univariate_ts_object with multiseasonal, multivariate ts object", {
  ...
  function_output <- force_to_univariate_ts_object(ts_object = ts_object)
...
test_that("check force_to_univariate_ts_object with uniseasonal, multivariate ts object", {
  ts_object <- tstools::initialize_ts_forecast_data(
      data = dummy_gasprice, 
      date_col = "year_month", 
      col_of_interest = "gasprice", 
...
test_that("check force_to_univariate_ts_object with uniseasonal, univariate ts object", {
  ts_object <- tstools::initialize_ts_forecast_data(
      data = dummy_gasprice, 
      date_col = "year_month", 
      col_of_interest = "gasprice", 
...
test_that("check force_to_univariate_ts_object with multiseasonal, univariate ts object", {
  ts_object <- tstools::initialize_ts_forecast_data(
      data = dummy_gasprice, 
      date_col = "year_month", 
      col_of_interest = "gasprice", 
...
test_that("check force_to_univariate_ts_object with non-ts objects", {
  expect_error(
    force_to_univariate_ts_object(ts_object = dummy_gasprice)
  )
  non_ts_object <- tstools::initialize_ts_forecast_data(
    ...
    dplyr::filter(grouping == "state = New York   &   oil_company = CompanyA") 
  expect_error(
    force_to_univariate_ts_object(ts_object = non_ts_object)
  ) 
  non_ts_object <- tstools::initialize_ts_forecast_data(
      data = dummy_gasprice, 
      date_col = "year_month", 
